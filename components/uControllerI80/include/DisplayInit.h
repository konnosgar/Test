...
DRAM_ATTR static const TScreenCommand ILI9163_InitCommandArray[] = {
	...
	// {ILI9163_FRCTL1, 	{0x08, 0x02}, 2},	// Frame Rate Control (Normal Mode / Full Colors) / 0x08 0x02 = 102.88 FPS
	{ILI9163_FRCTL1, 	{0x06, 0x14}, 2},	// Frame Rate Control (Normal Mode / Full Colors)
